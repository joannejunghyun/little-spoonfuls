export const translations = {
  en: {
    ...
    noProfilePopupTitle: "Profile required",
    noProfilePopupBody: "A profile is needed to get personalized meal recommendations for your baby.",
    noProfilePopupStay: "Set Up Profile",
    addBabyBtn: "+ Add Baby",
    editBtn: "Edit",
    ...
    diets: {
      all: "Omnivore (no restrictions)",
      pescatarian: "Pescatarian (no meat — fish OK)",
      "lacto-ovo": "Lacto-Ovo Vegetarian (no meat/fish — dairy & eggs OK)",
    ...
    landing: {
      ...
      loginSubtitle: "New or returning — it works the same way.",
  ...
  ko: {
    ...
    noProfilePopupTitle: "프로필 설정이 필요해요",
    noProfilePopupBody: "프로필을 설정해야 아이에게 딱 맞는 이유식 추천이 가능해요.",
    noProfilePopupStay: "프로필 설정하기",
    addBabyBtn: "+ 아기 추가",
    editBtn: "수정",
    ...
    diets: {
      all: "일반식 (제한 없음)",
      pescatarian: "페스코 채식 (고기 제외, 생선 OK)",
      "lacto-ovo": "락토오보 채식 (고기·생선 제외, 유제품·달걀 OK)",
      lacto: "락토 채식 (고기·생선·달걀 제외, 유제품 OK)",
      ovo: "오보 채식 (고기·생선·유제품 제외, 달걀 OK)",
      vegan: "완전 채식 (동물성 전부 제외)",
    },
    ...
    landing: {
      ...
      loginTitle: "로그인 · 회원가입",
      loginSubtitle: "처음 방문이든 기존 회원이든, 같은 방법으로 시작해요.",
